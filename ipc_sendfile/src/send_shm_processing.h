/*
 * send_msh_processing.h
 *
 *  Created on: Feb 25, 2022
 *      Author: maksim
 */

#ifndef SRC_SEND_SHM_PROCESSING_H_
#define SRC_SEND_SHM_PROCESSING_H_
...
void *get_shared_memory_pointer(char *, unsigned);

int send_shm_processing(char *);

#endif /* SRC_SEND_SHM_PROCESSING_H_ */
